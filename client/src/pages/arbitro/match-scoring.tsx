  ...
  const handleConfirmResult = () => {
    ...
    try {
      ...
      if (updatedMatch) {
        ...
        setTimeout(() => setLocation("/arbitro/dashboard"), 2000);
      } else {
      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <Button onClick={() => setLocation("/arbitro/dashboard")} className="mt-4">
              Volver al Dashboard
            </Button>
          </CardContent>
        </Card>
                  ...
                  {hasError && (
                    <Alert variant="destructive" className="mt-2">
                      <AlertDescription className="text-sm">
                        ...
                        {p1 === 11 && p2 > 9 && " Cuando un jugador tiene 11, el oponente debe tener 9 o menos."}
                        {p1 > 11 && Math.abs(p1 - p2) !== 2 && " Cuando se pasa de 11, la diferencia debe ser exactamente 2."}
                      </AlertDescription>
                    </Alert>
                  )}
                </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Los jugadores deben confirmar su año de nacimiento para validar el resultado
              </CardDescription>
            </CardHeader>
            <CardContent>
              <BirthYearValidation
